...
export default function Services() {
  ...
  return (
    <section ref={ref} className="py-44 md:py-52 px-6 relative services-section">
      {/* Subtle section glow */}
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[1, 2, 3].map((item) => (
            ...
            >
              ...
              <h3 className="text-2xl font-medium mb-6 text-center text-white opacity-0">5G Wi-Fi</h3>
